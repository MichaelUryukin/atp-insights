...
grant usage on database ATP_INSIGHTS to role ACCOUNTADMIN;
grant usage on schema ATP_INSIGHTS.DEFAULT to role ACCOUNTADMIN;
grant create data metric function on schema ATP_INSIGHTS.DEFAULT to role ACCOUNTADMIN;
