...
AS (
	SELECT
		...
		TOURNAMENT_SURFACE,
		TOURNAMENT_LEAGUE
	FROM ATP_INSIGHTS.DEFAULT.MATCHES_SAMPLE_100_ENRICHED
);

-- Grant USAGE on the Cortex Search Service
GRANT USAGE ON CORTEX SEARCH SERVICE ATP_INSIGHTS.DEFAULT.ATP_CORTEX_SEARCH TO ROLE PC_DATAIKU_ROLE;
